...
export const PRODUCTS: Product[] = [
  // ── Obst & Gemüse ──────────────────────────────────────────────
  P({ id: 'banane', name: 'Bio-Bananen', brand: 'NaturWert', markenartikel: true, category: 'Obst & Gemüse', ean: '42101001', unit: '1 kg', price: 2.29, promo: 1.89, base: '1,89 €/kg', margin: 26, velocity: 2400, stock: 860, demand: 74, season: 55, regionality: 40, region: 'Bundesweit', emoji: '🍌', segments: ['familien', 'stamm'], period: '24.08.–29.08.', bio: true }),
  P({ id: 'cherrytomaten', name: 'Cherrytomaten', brand: 'Rosella', markenartikel: true, category: 'Obst & Gemüse', ean: '42101007', unit: '250-g-Schale', price: 1.49, promo: 0.99, base: '3,96 €/kg', margin: 31, velocity: 980, stock: 420, demand: 82, season: 88, regionality: 42, region: 'West', emoji: '🍅', segments: ['veggie'], period: '24.08.–29.08.' }),
  P({ id: 'apfel', name: 'Elstar Äpfel, regional', brand: 'LandObst Nord', markenartikel: true, category: 'Obst & Gemüse', ean: '42101011', unit: '1,5-kg-Beutel', price: 2.99, promo: 2.49, base: '1,66 €/kg', margin: 29, velocity: 1340, stock: 940, demand: 71, season: 62, regionality: 95, region: 'Nord', emoji: '🍎', segments: ['familien', 'stamm'], period: '24.08.–29.08.' }),
  P({ id: 'eisberg', name: 'Eisbergsalat', brand: 'GartenFrisch', markenartikel: true, category: 'Obst & Gemüse', ean: '42101015', unit: '1 Stück', price: 1.19, promo: 0.79, base: '0,79 €/Stück', margin: 24, velocity: 760, stock: 150, demand: 68, season: 90, regionality: 55, region: 'Süd', emoji: '🥬', segments: ['preis', 'veggie'], period: '24.08.–29.08.' }),
  P({ id: 'kartoffel', name: 'Kartoffeln, festkochend', brand: 'Feldfrisch', markenartikel: true, category: 'Obst & Gemüse', ean: '42101019', unit: '2,5-kg-Sack', price: 2.79, promo: 1.99, base: '0,80 €/kg', margin: 33, velocity: 1890, stock: 1200, demand: 66, season: 58, regionality: 80, region: 'Nord', emoji: '🥔', segments: ['familien', 'veggie'], period: '24.08.–29.08.' }),
  P({ id: 'zucchini', name: 'Zucchini', brand: 'Rosella', markenartikel: true, category: 'Obst & Gemüse', ean: '42101023', unit: '500 g', price: 1.49, promo: 1.19, base: '2,38 €/kg', margin: 30, velocity: 690, stock: 380, demand: 79, season: 86, regionality: 60, region: 'Süd', emoji: '🥒', segments: ['veggie'], period: '24.08.–29.08.' }),

  // ── Fleisch ────────────────────────────────────────────────────
  P({ id: 'hack', name: 'Rinderhackfleisch', brand: 'Landfleisch', markenartikel: true, category: 'Fleisch', ean: '42102004', unit: '500-g-Packung', price: 4.49, promo: 3.59, base: '7,18 €/kg', margin: 34, velocity: 1620, stock: 540, demand: 88, season: 71, regionality: 65, region: 'Bundesweit', emoji: '🥩', img: '/img/hero-hack.jpg', segments: ['familien', 'stamm'], period: '24.08.–29.08.' }),
  P({ id: 'filet', name: 'Grill-Schweinefilet, pfeffermariniert', brand: 'Landfleisch', markenartikel: true, category: 'Fleisch', ean: '42102009', unit: '400 g', price: 5.99, promo: 4.79, base: '11,98 €/kg', margin: 38, velocity: 640, stock: 210, demand: 91, season: 95, regionality: 50, region: 'West', emoji: '🍖', segments: ['grill'], period: '24.08.–29.08.' }),
  P({ id: 'haehnchen', name: 'Hähnchenbrustfilet', brand: 'Gut Geflügel', markenartikel: true, category: 'Fleisch', ean: '42102013', unit: '500 g', price: 5.49, promo: 4.29, base: '8,58 €/kg', margin: 36, velocity: 1210, stock: 460, demand: 85, season: 80, regionality: 45, region: 'Nord', emoji: '🍗', segments: ['grill', 'singles'], period: '24.08.–29.08.' }),
  P({ id: 'grillwurst', name: 'Thüringer Grillwurst', brand: 'Wurst König', markenartikel: true, category: 'Fleisch', ean: '42102017', unit: '400 g', price: 2.99, promo: 2.49, base: '6,23 €/kg', margin: 35, velocity: 1480, stock: 620, demand: 94, season: 97, regionality: 70, region: 'Ost', emoji: '🌭', segments: ['grill'], period: '24.08.–29.08.' }),
  P({ id: 'mettenden', name: 'Mettenden, 2 Stück', brand: 'Wurst König', markenartikel: true, category: 'Fleisch', ean: '42102021', unit: '2 × 90 g', price: 2.69, promo: 1.99, base: '11,06 €/kg', margin: 32, velocity: 840, stock: 260, demand: 86, season: 93, regionality: 60, region: 'Ost', emoji: '🥓', segments: ['grill'], period: '24.08.–29.08.' }),
  P({ id: 'steak', name: 'Rumpsteak', brand: 'Landfleisch Premium', markenartikel: true, category: 'Fleisch', ean: '42102025', unit: '500 g', price: 8.99, promo: 6.99, base: '13,98 €/kg', margin: 41, velocity: 410, stock: 140, demand: 89, season: 91, regionality: 40, region: 'West', emoji: '🥩', segments: ['grill'], period: '24.08.–29.08.' }),

  // ── Molkerei ───────────────────────────────────────────────────
  P({ id: 'milch', name: 'Frische Vollmilch 3,5 %', brand: 'Molkerei Ammerland', markenartikel: true, category: 'Molkerei', ean: '42103002', unit: '1-l-Flasche', price: 1.29, promo: 0.99, base: '0,99 €/l', margin: 18, velocity: 3200, stock: 2100, demand: 70, season: 55, regionality: 85, region: 'Nord', emoji: '🥛', segments: ['familien', 'stamm'], period: '24.08.–29.08.' }),
  P({ id: 'butter', name: 'Deutsche Markenbutter', brand: 'Molkerei Ammerland', markenartikel: true, category: 'Molkerei', ean: '42103006', unit: '250-g-Stück', price: 2.19, promo: 1.79, base: '7,16 €/kg', margin: 27, velocity: 1560, stock: 890, demand: 64, season: 50, regionality: 55, region: 'Bundesweit', emoji: '🧈', segments: ['familien'], period: '24.08.–29.08.' }),
  P({ id: 'gouda', name: 'Gouda jung, am Stück', brand: 'Käsehof', markenartikel: true, category: 'Molkerei', ean: '42103010', unit: '400 g', price: 3.49, promo: 2.79, base: '6,98 €/kg', margin: 33, velocity: 1290, stock: 700, demand: 69, season: 54, regionality: 45, region: 'Bundesweit', emoji: '🧀', segments: ['familien', 'veggie'], period: '24.08.–29.08.' }),
  P({ id: 'skyr', name: 'Skyr Natur, Protein', brand: 'NordMilch', markenartikel: true, category: 'Molkerei', ean: '42103014', unit: '500-g-Becher', price: 1.69, promo: 1.29, base: '2,58 €/kg', margin: 38, velocity: 1150, stock: 480, demand: 92, season: 66, regionality: 35, region: 'West', emoji: '🥣', segments: ['singles'], period: '24.08.–29.08.', bio: true }),
  P({ id: 'schmand', name: 'Schmand', brand: 'Molkerei Ammerland', markenartikel: true, category: 'Molkerei', ean: '42103018', unit: '200-g-Becher', price: 0.85, promo: 0.69, base: '3,45 €/kg', margin: 35, velocity: 640, stock: 330, demand: 58, season: 48, regionality: 40, region: 'Bundesweit', emoji: '🫙', segments: ['familien'], period: '24.08.–29.08.' }),
  P({ id: 'feta', name: 'Hirtenkäse 45 % i. Tr.', brand: 'Hellasa', markenartikel: true, category: 'Molkerei', ean: '42103022', unit: '200-g-Packung', price: 1.99, promo: 1.49, base: '7,45 €/kg', margin: 36, velocity: 880, stock: 410, demand: 83, season: 84, regionality: 30, region: 'Süd', emoji: '🐑', segments: ['veggie', 'singles'], period: '24.08.–29.08.' }),

  // ── Getränke ───────────────────────────────────────────────────
  P({ id: 'cola', name: 'Cola', brand: 'FritzBräu', markenartikel: true, category: 'Getränke', ean: '42104001', unit: '1,5-l-PET-Flasche', price: 1.49, promo: 0.99, base: '0,66 €/l', deposit: 0.25, margin: 22, velocity: 2600, stock: 1500, demand: 87, season: 84, regionality: 30, region: 'Bundesweit', emoji: '🥤', segments: ['familien'], period: '24.08.–29.08.' }),
  P({ id: 'osaft', name: 'Orangensaft, direkt', brand: 'SunValley', markenartikel: true, category: 'Getränke', ean: '42104005', unit: '1-l-Flasche', price: 1.99, promo: 1.49, base: '1,49 €/l', margin: 28, velocity: 1420, stock: 810, demand: 72, season: 62, regionality: 25, region: 'Bundesweit', emoji: '🧃', segments: ['familien'], period: '24.08.–29.08.' }),
  P({ id: 'pils', name: 'Pils, Kasten', brand: 'Nordbräu', markenartikel: true, category: 'Getränke', ean: '42104009', unit: '20 × 0,5 l', price: 12.99, promo: 9.99, base: '1,00 €/l', deposit: 3.1, uvp: 13.99, margin: 30, velocity: 540, stock: 300, demand: 90, season: 92, regionality: 75, region: 'Nord', emoji: '🍺', segments: ['grill', 'stamm'], period: '24.08.–29.08.' }),
  P({ id: 'wasser', name: 'Mineralwasser, medium', brand: 'QuellRein', markenartikel: true, category: 'Getränke', ean: '42104013', unit: '6 × 1,5 l', price: 3.99, promo: 2.99, base: '0,33 €/l', deposit: 0.9, margin: 24, velocity: 1750, stock: 980, demand: 89, season: 87, regionality: 30, region: 'Bundesweit', emoji: '💧', segments: ['familien', 'preis'], period: '24.08.–29.08.' }),
  P({ id: 'apfelsaft', name: 'Bio-Apfelsaft, regional', brand: 'LandObst Nord', markenartikel: true, category: 'Getränke', ean: '42104017', unit: '1-l-Flasche', price: 2.29, promo: 1.89, base: '1,89 €/l', margin: 31, velocity: 620, stock: 340, demand: 67, season: 60, regionality: 90, region: 'Nord', emoji: '🍏', segments: ['stamm', 'veggie'], period: '24.08.–29.08.', bio: true }),

  // ── Tiefkühl ───────────────────────────────────────────────────
  P({ id: 'pizza', name: 'Pizza Salami', brand: 'Ristorante Casa', markenartikel: true, category: 'Tiefkühl', ean: '42105003', unit: '335-g-Packung', price: 1.99, promo: 1.49, base: '4,45 €/kg', margin: 30, velocity: 1980, stock: 1150, demand: 81, season: 57, regionality: 20, region: 'Bundesweit', emoji: '🍕', segments: ['familien', 'singles'], period: '24.08.–29.08.' }),
  P({ id: 'spinat', name: 'Rahmspinat', brand: 'FrostaGreen', markenartikel: true, category: 'Tiefkühl', ean: '42105007', unit: '450-g-Packung', price: 1.19, promo: 0.89, base: '1,98 €/kg', margin: 29, velocity: 540, stock: 290, demand: 55, season: 44, regionality: 20, region: 'Bundesweit', emoji: '🍃', segments: ['veggie'], period: '24.08.–29.08.' }),
  P({ id: 'pommes', name: 'Pommes frites', brand: 'FrostaGreen', markenartikel: true, category: 'Tiefkühl', ean: '42105011', unit: '1-kg-Beutel', price: 1.89, promo: 1.39, base: '1,39 €/kg', margin: 27, velocity: 1640, stock: 920, demand: 77, season: 74, regionality: 20, region: 'Bundesweit', emoji: '🍟', segments: ['familien'], period: '24.08.–29.08.' }),
  P({ id: 'eis', name: 'Vanilleeis', brand: 'Eisglück', markenartikel: true, category: 'Tiefkühl', ean: '42105015', unit: '1-l-Becher', price: 1.99, promo: 1.49, base: '1,49 €/l', margin: 28, velocity: 890, stock: 470, demand: 88, season: 96, regionality: 25, region: 'Bundesweit', emoji: '🍦', segments: ['familien'], period: '24.08.–29.08.' }),

  // ── Backwaren ──────────────────────────────────────────────────
  P({ id: 'brot', name: 'Mehrkornbrot, Ofenfrisch', brand: 'Bäckerei Hansen', markenartikel: true, category: 'Backwaren', ean: '42106002', unit: '750-g-Laib', price: 1.99, promo: 1.59, base: '2,12 €/kg', margin: 25, velocity: 1730, stock: 780, demand: 73, season: 52, regionality: 88, region: 'Nord', emoji: '🍞', segments: ['familien', 'stamm'], period: '24.08.–29.08.' }),
  P({ id: 'croissant', name: 'Butter-Croissants', brand: 'Bäckerei Hansen', markenartikel: true, category: 'Backwaren', ean: '42106006', unit: '4er-Packung', price: 1.49, promo: 0.99, base: '0,99 €/Packung', margin: 30, velocity: 1240, stock: 560, demand: 75, season: 58, regionality: 50, region: 'West', emoji: '🥐', segments: ['singles', 'familien'], period: '24.08.–29.08.' }),
  P({ id: 'toast', name: 'Vollkorn-Toast', brand: 'GoldenCrust', markenartikel: true, category: 'Backwaren', ean: '42106010', unit: '500-g-Packung', price: 0.99, promo: 0.79, base: '1,58 €/kg', margin: 20, velocity: 1510, stock: 840, demand: 62, season: 49, regionality: 25, region: 'Bundesweit', emoji: '🥪', segments: ['preis', 'singles'], period: '24.08.–29.08.' }),
  P({ id: 'baguette', name: 'Baguette, 2 Stück', brand: 'Bäckerei Hansen', markenartikel: true, category: 'Backwaren', ean: '42106014', unit: '2 × 150 g', price: 1.29, promo: 0.99, base: '3,30 €/kg', margin: 28, velocity: 1110, stock: 620, demand: 84, season: 85, regionality: 60, region: 'Nord', emoji: '🥖', segments: ['grill', 'familien'], period: '24.08.–29.08.' }),

  // ── Feinkost ───────────────────────────────────────────────────
  P({ id: 'penne', name: 'Penne Rigate, Hartweizen', brand: 'Pastaria', markenartikel: true, category: 'Feinkost', ean: '42107004', unit: '500-g-Packung', price: 0.99, promo: 0.79, base: '1,58 €/kg', margin: 34, velocity: 1380, stock: 760, demand: 70, season: 53, regionality: 20, region: 'Bundesweit', emoji: '🍝', segments: ['familien', 'singles', 'preis'], period: '24.08.–29.08.' }),
  P({ id: 'bbq', name: 'BBQ-Sauce, rauchig', brand: 'SmokyJoe', markenartikel: true, category: 'Feinkost', ean: '42107008', unit: '300-ml-Flasche', price: 1.89, promo: 1.49, base: '4,97 €/l', margin: 39, velocity: 520, stock: 240, demand: 93, season: 94, regionality: 25, region: 'Bundesweit', emoji: '🥫', segments: ['grill'], period: '24.08.–29.08.' }),
  P({ id: 'kartoffelsalat', name: 'Kartoffelsalat, klassisch', brand: 'Feinkost Meyer', markenartikel: true, category: 'Feinkost', ean: '42107012', unit: '500-g-Becher', price: 1.79, promo: 1.49, base: '2,98 €/kg', margin: 31, velocity: 610, stock: 280, demand: 87, season: 89, regionality: 45, region: 'Nord', emoji: '🥗', segments: ['grill', 'familien'], period: '24.08.–29.08.' }),

  // ── Snacks ─────────────────────────────────────────────────────
  P({ id: 'chips', name: 'Kartoffelchips Paprika', brand: 'Crunchy', markenartikel: true, category: 'Snacks', ean: '42108101', unit: '200-g-Tüte', price: 1.59, promo: 1.19, base: '5,95 €/kg', margin: 42, velocity: 1500, stock: 820, demand: 85, season: 76, regionality: 20, region: 'Bundesweit', emoji: '🌶️', segments: ['preis', 'singles'], period: '24.08.–29.08.' }),
  P({ id: 'schoko', name: 'Vollmilch-Schokolade', brand: 'AlpenGold', markenartikel: true, category: 'Snacks', ean: '42108105', unit: '100-g-Tafel', price: 0.99, promo: 0.69, base: '6,90 €/kg', margin: 35, velocity: 1350, stock: 740, demand: 66, season: 51, regionality: 15, region: 'Bundesweit', emoji: '🍫', segments: ['singles', 'preis'], period: '24.08.–29.08.' }),
  P({ id: 'nuesse', name: 'Studentenfutter', brand: 'NussWerk', markenartikel: true, category: 'Snacks', ean: '42108109', unit: '200-g-Beutel', price: 1.99, promo: 1.59, base: '7,95 €/kg', margin: 37, velocity: 460, stock: 210, demand: 61, season: 46, regionality: 15, region: 'West', emoji: '🥜', segments: ['veggie', 'singles'], period: '24.08.–29.08.' }),

  // ── Haushalt ───────────────────────────────────────────────────
  P({ id: 'spueli', name: 'Spülmittel, Zitrone', brand: 'ReinKlar', markenartikel: true, category: 'Haushalt', ean: '42109103', unit: '500-ml-Flasche', price: 1.79, promo: 1.29, base: '2,58 €/l', margin: 44, velocity: 780, stock: 560, demand: 52, season: 40, regionality: 10, region: 'Bundesweit', emoji: '🧴', segments: ['familien', 'preis'], period: '24.08.–29.08.' }),
  P({ id: 'kuechenrolle', name: 'Küchenrolle, 3-lagig', brand: 'PapierWerk', markenartikel: true, category: 'Haushalt', ean: '42109107', unit: '2er-Packung', price: 2.49, promo: 1.99, base: '1,00 €/Rolle', margin: 40, velocity: 690, stock: 430, demand: 50, season: 38, regionality: 10, region: 'Bundesweit', emoji: '🧻', segments: ['familien'], period: '24.08.–29.08.' }),

  // ── Unbranded / Lose Ware (KI-generierung erlaubt) ─────────────
  P({ id: 'lose-apfel', name: 'Äpfel, regional, loses Obst', brand: '', markenartikel: false, category: 'Obst & Gemüse', ean: '', unit: '1 kg', price: 2.49, promo: 1.99, base: '1,99 €/kg', margin: 28, velocity: 1100, stock: 800, demand: 68, season: 60, regionality: 90, region: 'Nord', emoji: '🍎', segments: ['familien', 'stamm', 'veggie'], period: '24.08.–29.08.' }),
  P({ id: 'lose-kartoffel', name: 'Kartoffeln, festkochend, lose', brand: '', markenartikel: false, category: 'Obst & Gemüse', ean: '', unit: '1 kg', price: 1.49, promo: 0.99, base: '0,99 €/kg', margin: 35, velocity: 1600, stock: 1000, demand: 62, season: 55, regionality: 85, region: 'Nord', emoji: '🥔', segments: ['familien', 'preis', 'veggie'], period: '24.08.–29.08.' }),
  P({ id: 'lose-tomate', name: 'Rispentomaten, lose', brand: '', markenartikel: false, category: 'Obst & Gemüse', ean: '', unit: '1 kg', price: 3.99, promo: 2.99, base: '2,99 €/kg', margin: 30, velocity: 900, stock: 600, demand: 75, season: 85, regionality: 50, region: 'Süd', emoji: '🍅', segments: ['veggie', 'stamm'], period: '24.08.–29.08.' }),
  P({ id: 'landbrot', name: 'Landbrot, Hausbackerei', brand: '', markenartikel: false, category: 'Backwaren', ean: '', unit: '1 Stück', price: 1.99, promo: 1.49, base: '1,49 €/Stück', margin: 42, velocity: 1400, stock: 500, demand: 70, season: 45, regionality: 70, region: 'Nord', emoji: '🍞', segments: ['familien', 'stamm'], period: '24.08.–29.08.' }),
]
